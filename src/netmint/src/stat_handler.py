...
class StatsHandler:
    ...
    def __init__(self,name):
        ...
        self.period     = name
        self.directory     = "output/extra_network_results/"
        self.ks     = []
        self.r_squared     = []
...
# -----------------------------------------
    ...
    def save_ks_s(self):
        ...
        file_ks = open (self.directory+"distributions_{0}.csv".format(self.period),'w')
        for line in self.ks:
        ...
        file_r = open (self.directory+"correlation_lists_{0}.csv".format(self.period),'w')
